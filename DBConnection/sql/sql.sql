...
START TRANSACTION;
USE `desertdb`;
INSERT INTO `desertdb`.`Level` (`level`, `rows`) VALUES (1, 10);
INSERT INTO `desertdb`.`Level` (`level`, `rows`) VALUES (2, 1);
INSERT INTO `desertdb`.`Level` (`level`, `rows`) VALUES (3, 1);
INSERT INTO `desertdb`.`Level` (`level`, `rows`) VALUES (4, 1);
INSERT INTO `desertdb`.`Level` (`level`, `rows`) VALUES (5, 1);
INSERT INTO `desertdb`.`Level` (`level`, `rows`) VALUES (6, 1);
INSERT INTO `desertdb`.`Level` (`level`, `rows`) VALUES (7, 1);
INSERT INTO `desertdb`.`Level` (`level`, `rows`) VALUES (8, 1);
INSERT INTO `desertdb`.`Level` (`level`, `rows`) VALUES (9, 1);
INSERT INTO `desertdb`.`Level` (`level`, `rows`) VALUES (10, 1);
