...
START TRANSACTION;
USE `desertdb`;
INSERT INTO `desertdb`.`Level` (`level`, `rows`, `coef`, `timelimit`, `type`) VALUES (1, 10, 1, 90, DEFAULT);
INSERT INTO `desertdb`.`Level` (`level`, `rows`, `coef`, `timelimit`, `type`) VALUES (2, 1, 1, 90, DEFAULT);
INSERT INTO `desertdb`.`Level` (`level`, `rows`, `coef`, `timelimit`, `type`) VALUES (3, 1, 1, 90, DEFAULT);
INSERT INTO `desertdb`.`Level` (`level`, `rows`, `coef`, `timelimit`, `type`) VALUES (4, 1, 1, 90, DEFAULT);
INSERT INTO `desertdb`.`Level` (`level`, `rows`, `coef`, `timelimit`, `type`) VALUES (5, 1, 1, 90, DEFAULT);
INSERT INTO `desertdb`.`Level` (`level`, `rows`, `coef`, `timelimit`, `type`) VALUES (6, 1, 1, 90, DEFAULT);
INSERT INTO `desertdb`.`Level` (`level`, `rows`, `coef`, `timelimit`, `type`) VALUES (7, 1, 1, 90, DEFAULT);
INSERT INTO `desertdb`.`Level` (`level`, `rows`, `coef`, `timelimit`, `type`) VALUES (8, 1, 1, 90, DEFAULT);
INSERT INTO `desertdb`.`Level` (`level`, `rows`, `coef`, `timelimit`, `type`) VALUES (9, 1, 1, 90, DEFAULT);
INSERT INTO `desertdb`.`Level` (`level`, `rows`, `coef`, `timelimit`, `type`) VALUES (10, 1, 1, 90, DEFAULT);
