...
function PlayerMissile(source, endX, endY) {
  ...
  Missile.call(this, {
    ...
    endY: endY,
    color: 'brown',
    trailColor: 'rgba(200,50,50,0.5)',
    explodeColor: 'rgba(255,230,200,0.5)'
  });
...
function EnemyMissile(targets) {
  ...
  Missile.call(this, {
    ...
    endY: target[1],
    color: 'white',
    trailColor: 'rgba(222,222,222,0.5)',
    explodeColor: 'rgba(200,100,100,0.5)'
  });
...
function BonusMissile(targets) {
  ...
  Missile.call(this, {
    ...
    color: 'blue',
    trailColor: '#00ffff',
    explodeColor: 'rgba(118,238,144,0.4)'
  });
...
function userSolutionChecker() {
  ...
  missileCommand(true);
  var numMiss0 = antiMissileBatteries[0].missilesLeft;
  var numMiss1 = antiMissileBatteries[2].missilesLeft;

  if (numMiss0 == 6 && numMiss1 == 6) {
    return {
      passed: true,
      msg: "Excellent! That will give them a taste of their own medicine!"
    }
  } else if (numMiss0 > 6 || numMiss1 > 6) {
    return {
      passed: false,
      msg: "Are you trying to be witty? Anti-missile batteries cannot store more than 6 missiles! Correct it before the whole place blows up!"
    }
  } else if (numMiss0 > 0 && numMiss0 < 6 && numMiss1 > 0 && numMiss1 < 6) {
    return {
      passed: false,
      msg: "I said SIX missiles in each anti-missile battery. S-I-X ! Are you even paying attention?"
    }
  } else {
    return {
      passed: false,
      msg: "Doesn't seem like a viable solution to me. Get back to work!"
    }
  }
