...
function userSolutionChecker(){
  ...
  if (test == 30){
    return {
      passed: true,
      msg: "Seems like the speed is back to normal. Good job!"
    }
  } else {
    return {
      passed: false,
      msg: "The speed is still out of whack! We can't detect attacks and react effectively this way. Try again!"
    }
  }
}
