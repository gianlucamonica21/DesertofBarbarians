...
try {
  ...
  if(err.name == "RangeError"){
    writeChatMessage("Careful there! You created an infinite loop!", "soldierMsg");
...
if (numCalled > 1) {
  return {
    passed: true,
    msg: "Wonderful! Now we won't be the laughing stock of the other camps anymore!"
  }
} else {
  return {
    passed: false,
    msg: "That's not how the pros do it! Try again!"
  }
}
